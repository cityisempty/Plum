...
export const UserInfoDialog: React.FC<UserInfoDialogProps> = ({
    ...
    return (
        <div className={`fixed inset-0 z-50 flex items-center justify-center p-4 ${isDark ? 'bg-black/90' : 'bg-black/60'}`}>
            <div className={`relative w-full max-w-md rounded-2xl shadow-2xl p-6 ${isDark ? 'bg-slate-900 text-white' : 'bg-white text-slate-900'}`}>
                {/* 标题 */}
                <h2 className="text-xl font-light text-center mb-6 tracking-wide">
                    {initialValues ? '请输入新的决策主题' : '欢迎!请先告诉我们关于你'}
                </h2>

                {/* 性别选择 */}
                <div className="mb-6">
                    <label className="block text-sm font-medium mb-3 opacity-70">性别</label>
                    <div className="flex gap-4 justify-center">
                        ...
                        >
                            ...
                            />
                            <p className="text-center mt-2 text-sm font-medium">男性</p>
                        </div>
                        ...
                        >
                            <AvatarImage
                                ...
                                className="w-24 h-32 object-cover rounded-lg"
                            />
                            <p className="text-center mt-2 text-sm font-medium">女性</p>
                        </div>
                    </div>
                </div>
                ...
                {/* 决策主题 */}
                <div className="mb-6">
                    <label className="block text-sm font-medium mb-2 opacity-70">决策主题</label>
                    <div className="relative">
                        <input
                            ref={inputRef}
                            type="text"
                ...
                <div className="flex gap-3">
                    <button
                        ...
                        disabled={!canSubmit}
                        className={`flex-1 px-6 py-3 rounded-lg font-medium transition-all ${canSubmit
                            ? isDark
                ...
                {loadingProgress < 100 && (
                    <div className="mt-4">
                        <div className="flex items-center justify-between mb-1">
                            <span className="text-xs opacity-50">正在准备卡牌...</span>
                            <span className="text-xs opacity-50">{loadingProgress}%</span>
                        </div>
